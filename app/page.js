...
const DevAgencyWebsite = () => {
  ...
  return (
    <Layout>
      ...
      {/* Contact Form */}
      <section id="contact" className="py-10 w-full px-4 pb-20">
        <div className="container mx-auto">
          ...
          >
            ...
            <div className="space-y-8">
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 px-4">
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-2xl p-8 px-4">
